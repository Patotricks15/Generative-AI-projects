...
class KeyDevelopment(BaseModel):
    ...
    year: str = Field(
        ..., description="The year or century when there was an important historic development. Values before christ needs to be negative"
    )
...
for i in key_developments:
    print(f"{i.year} -> {i.description}\n")